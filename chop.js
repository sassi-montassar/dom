...
function comm() {
    ...
    let heart = document.querySelector(".fas fa-heart");
...
function addItemToCart(title, price, imageSrc) {
    ...
    var cartRowContents = `
        ...
        <div class="cart-quantity cart-column">
            ...
            <span class="cart-couer cart-header cart-column"><i class="fas fa-heart"></i></span>
        </div>`
...
document.querySelector('fas fa-heart').onclik = function(){
